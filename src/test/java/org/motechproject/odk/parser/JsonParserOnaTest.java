...
public class JsonParserOnaTest {
    ...
    private FormDefinition createFormDefinition () {
        ...
        formElements.add(new FormElement("text_widgets/my_string","text_widgets/my_string", "string"));
        formElements.add(new FormElement("text_widgets/my_long_text","text_widgets/my_long_text", "string"));
        formElements.add(new FormElement("number_widgets/my_int","number_widgets/my_int", "int"));
        formElements.add(new FormElement("cascading_widgets/group1/country","cascading_widgets/group1/country", "select1"));
        formElements.add(new FormElement("select_widgets/select_horizontal","select_widgets/select_horizontal", "select"));
        formElements.add(new FormElement("geopoint_widgets/my_geoshape","geopoint_widgets/my_geoshape", "geoshape"));
        formElements.add(new FormElement("media_widgets/my_image","media_widgets/my_image", "binary"));
