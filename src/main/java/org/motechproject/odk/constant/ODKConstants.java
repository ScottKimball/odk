...
public class ODKConstants {
    ...
    public static final String META_SUBMISSION_DATE = "*meta-submission-date*";
    public static final String META_IS_COMPLETE = "*meta-is-complete*";
    public static final String META_DATE_MARKED_AS_COMPLETE = "*meta-date-marked-as-complete*";
}
